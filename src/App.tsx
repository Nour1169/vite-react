      ...
      <div className="site-container">
        ...
        <main id="top">
          <section className="hero">
            <div>
              <div className="eyebrow body-font">Antwerp • social • curated</div>
          ...
          <section id="vibe" className="section">
            <div className="section-kicker body-font">Vibe</div>
            <h2 className="section-title logo-font" style={{ marginBottom: 26 }}>
              Simple. Social. Curated.
            </h2>

            <div className="vibe-grid">
              <div className="vibe-card">
                <div className="vibe-number body-font">01</div>
                <h3 className="logo-font">Playful identity</h3>
                <p className="body-font">
                  Rounded typography, softer forms and a visual style that matches the logo.
                </p>
              </div>

              <div className="vibe-card">
                <div className="vibe-number body-font">02</div>
                <h3 className="logo-font">Curated atmosphere</h3>
                <p className="body-font">
                  A concept built around moments that feel intentional, warm and aesthetically strong.
                </p>
              </div>

              <div className="vibe-card">
                <div className="vibe-number body-font">03</div>
                <h3 className="logo-font">Real connection</h3>
                <p className="body-font">
                  Less clutter, less noise, more people, more feeling and more identity.
                </p>
              </div>
            </div>
          </section>
